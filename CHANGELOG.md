...
* fix(project): add retries and confirmation dialogs to handle save failures by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/426
* chore(deps): bump actions/download-artifact from 7.0.0 to 8.0.1 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/431
* chore(deps): bump geekyeggo/delete-artifact from 5.1.0 to 6.0.0 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/430
* chore(deps): bump tj-actions/changed-files from 47.0.1 to 47.0.5 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/429
* chore(deps): bump googleapis/release-please-action from 4.4.0 to 4.4.1 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/428
* chore(deps): bump actions/cache from 5.0.3 to 5.0.4 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/427
* feat(project): add `WorldTracker`s for pinning `Control` nodes to world entities by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/432
* chore: upgrade Godot to `v4.6.2-stable` by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/433
* fix(tools): normalize path segments for `poswap`'s "No translation found" comment by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/434
* fix(project): clean up error dialog on exit by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/435
* chore: upgrade Godot to `v4.6.3-stable` by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/436
...
* refactor(project): simplify `AlertDialog` usage and update consumers by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/411
* refactor(project): use screen pop results to decouple save slot menu by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/412
* chore(addons): update `std` to `v4.7.0` by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/413
* fix(project): use screen-level dependencies in main menu and maps by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/414
* feat(project): add support for screen open/close sounds by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/415
...
## What's Changed
* chore(deps): bump actions/checkout from 5.0.0 to 6.0.0 by @dependabot[bot] in https://github.com/coffeebeats/godot-project-template/pull/364
* fix(ci): reclaim disk space before compiling by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/366


**Full Changelog**: https://github.com/coffeebeats/godot-project-template/compare/v3.0.0...v3.0.1
...
## What's Changed
* chore: update to Godot `v4.4.1-stable` by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/326
* chore(addons): update addons to latest by @coffeebeats in https://github.com/coffeebeats/godot-project-template/pull/328


**Full Changelog**: https://github.com/coffeebeats/godot-project-template/compare/v2.0.1...v2.0.2

##
## project/menu/settings/controls/rebinder.gd
##
...
static var _logger := StdLogger.create(&"project/menu/settings/rebind")  # gdlint:ignore=class-definitions-order,max-line-length
